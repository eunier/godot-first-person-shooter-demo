namespace App.Modules.PlayerModule
{
	...
	public partial class Player : CharacterBody3D
	{
		...
		public override void _Ready()
		{
			...
			this.healthComponent = this.GetNode<Health>(
		...
		public override void _Input(InputEvent @event)
		{
			...
			if (@event.IsActionPressed(GlobalConstants.InputMap.UiCancel))
			{
		...
		{
			if (
				Input.IsActionJustPressed(action: GlobalConstants.InputMap.Jump)
				&& this.IsOnFloor()
			)
			{
